...
class SystemCore:
    ...
    def register_user(self, username, password):
        ...
        base_wallet = new_portfolio.add_wallet(base_currency)
        base_wallet.deposit(1000.0)
    ...
    def buy_currency(self, user: User, currency_code: str, amount: float):
        ...
        target_wallet = portfolio.add_wallet(target_code)
    ...
    def sell_currency(self, user: User, currency_code: str, amount: float):
        ...
        base_wallet = portfolio.add_wallet(base_currency)
